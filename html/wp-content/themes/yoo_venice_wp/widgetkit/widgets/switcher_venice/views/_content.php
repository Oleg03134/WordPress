...
<ul id="wk-<?php echo $settings['connect_id']; ?>" class="tm-switcher-venice-content uk-switcher uk-text-<?php echo $settings['text_align']; ?> <?php echo $margin; ?>" data-uk-check-display>
