...
<ul class="tm-switcher-venice-nav uk-hidden-small uk-grid<?php echo $nav; ?>" data-uk-<?php echo $javascript; ?>="{connect:'#wk-<?php echo $settings['connect_id']; ?>'<?php echo $animation; ?>}">
